...
public class WeekView extends View {
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onSwipeRight(float distanceX, float velocityX) {
            float minX = getXMinLimit();
            float maxX = getXMaxLimit();
            Log.d(this.getClass().getSimpleName(),"SWIPE RIGHT, distance: "+distanceX);
        ...
        public void onSwipeLeft(float distanceX, float velocityX) {
            float minX = getXMinLimit();
            float maxX = getXMaxLimit();
            Log.d(this.getClass().getSimpleName(),"SWIPE LEFT, distance: "+distanceX);
            Log.d(this.getClass().getSimpleName(), "MinX: "+minX+ " / MaxX: "+maxX);
            Log.d(this.getClass().getSimpleName(), "DayWitdth: "+mWidthPerDay+ " / ColumnGap: "+mColumnGap);
            Log.d(this.getClass().getSimpleName(),"CurrentOriginX: "+mCurrentOrigin.x);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d(this.getClass().getSimpleName(), "Check Action");
        switch( event.getAction() ) {
            case MotionEvent.ACTION_DOWN: {
                mayScroll = true;
                Log.d(this.getClass().getSimpleName(), "ACTION_DOWN, mayScroll: "+mayScroll);
            }
                break;
            case MotionEvent.ACTION_UP: {
                mayScroll = false;
                Log.d(this.getClass().getSimpleName(), "ACTION_UP, mayScroll: "+mayScroll);
            }
                break;
        }
    ...
    public void computeScroll() {
        ...
        Log.d(this.getClass().getSimpleName(), "computeScroll");
        if (mScroller.isFinished()) {
            ...
            if (mCurrentFlingDirection != Direction.NONE && forceFinishScroll()) {
                ...
                Log.d(this.getClass().getSimpleName(),"computeScrollOffset");
                mCurrentOrigin.y = mScroller.getCurrY();
                mCurrentOrigin.x = mScroller.getCurrX();
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        Log.d(this.getClass().getSimpleName(), "END of computeScroll; mayScroll: "+mayScroll);
    }
